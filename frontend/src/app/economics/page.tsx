  ...
  return (
    <div className={`min-h-screen ${theme.background} ${theme.text}`}>
      ...
      <main className="container mx-auto px-4 py-8 pt-16">
        <div className="mb-8">
          <h1 className={`text-4xl font-bold mb-2 ${theme.primary}`}>Economics Markets</h1>
        ...
        {filteredMarkets.length === 0 && (
          <div className="text-center py-12">
            <p className={`text-xl ${theme.textSecondary}`}>No economics markets available at the moment.</p>
          </div>
        )}
      </main>
    </div>
